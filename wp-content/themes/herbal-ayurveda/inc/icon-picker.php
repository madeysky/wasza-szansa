...
class Herbal_Ayurveda_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <div class="social-icon-search">
                <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'herbal-ayurveda' ); ?>">
            </div>
            ...
            <ul class="icon-list clearfix">
                <?php
                $herbal_ayurveda_font_awesome_icon_array = herbal_ayurveda_font_awesome_icon_array();
                foreach ($herbal_ayurveda_font_awesome_icon_array as $herbal_ayurveda_font_awesome_icon) {
                        $icon_class = $this->value() == $herbal_ayurveda_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($herbal_ayurveda_font_awesome_icon).'"></i>
                        <span class="herbal-ayurveda-social-class">'.esc_attr($herbal_ayurveda_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function herbal_ayurveda_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'herbal-ayurveda-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'herbal_ayurveda_customizer_script' );

if(!function_exists('herbal_ayurveda_font_awesome_icon_array')){
    function herbal_ayurveda_font_awesome_icon_array(){
